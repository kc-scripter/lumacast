export type PersistedParticipant={socketId:string;displayName:string;agoraUid:number;token:string};
export type PersistedRoom={id:string;ownerId:string;ownerName:string;ownerUid:number;ownerToken:string;participants:PersistedParticipant[]};
