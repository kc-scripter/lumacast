...
const io = new Server(httpServer, { cors: { origin, methods: ["GET", "POST"] }, maxHttpBufferSize: 1e6, pingTimeout: 20_000, pingInterval: 25_000 });
const rooms = registerSignaling(io);
