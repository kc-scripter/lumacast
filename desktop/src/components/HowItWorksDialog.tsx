import { MonitorUp, RadioTower, Share2, Users } from "lucide-react";
...
export function HowItWorksDialog({onClose}:{onClose:()=>void}){
  return <Modal title="Compartilhe sua tela em poucos segundos." eyebrow="COMO FUNCIONA" onClose={onClose} className="how-modal">
    ...
    <div className="feature-strip"><span>App + navegador</span><span>Baixa latência</span><span>Câmera + áudio</span><span>Sem gravação própria</span></div>
  </Modal>;
}
