...
function ViewerRoomPage({roomId}:{roomId:string}){
  const room=useCollaborativeRoom(false,roomId),[showStats,setShowStats]=useState(false),{quality,setQuality,fps,setFps}=useMediaPreferences(),canShare=typeof navigator.mediaDevices?.getDisplayMedia==="function";
