...
O desktop v2 está em desenvolvimento separado do site. Não use builds, checksums ou referências de versões desktop antigas como base para novas alterações.
